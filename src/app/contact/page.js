    ...
    <div className="p-6 bg-gray-100 min-h-screen rounded-lg mb-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="rounded-lg shadow-md p-4 bg-blue-500 text-white">
          ...
          <p className="text-lg mb-4 truncate">Email me at <a href="mailto:krishnasarathishem@gmail.com" className="underline" target="_blank" rel="noopener noreferrer">krishnasarathishem@gmail.com</a></p>
        ...
        <div className="rounded-lg shadow-md p-4 bg-green-500 text-white">
          ...
          <p className="text-lg mb-4 truncate">Connect with me on <a href="https://www.linkedin.com/in/imkrishnasarathi" className="underline" target="_blank" rel="noopener noreferrer">LinkedIn</a></p>
        ...
        <div className="rounded-lg shadow-md p-4 bg-blue-400 text-white">
          ...
          <p className="text-lg mb-4 truncate">Follow me on <a href="https://www.twitter.com/@CodesKae" className="underline" target="_blank" rel="noopener noreferrer">Twitter</a></p>
        ...
        <div className="rounded-lg shadow-md p-4 bg-gray-800 text-white">
          ...
          <p className="text-lg mb-4 truncate">Check out my projects on <a href="https://www.github.com/imkrishnasarathi" className="underline" target="_blank" rel="noopener noreferrer">GitHub</a></p>
